...
var part_sprite_frames = preload("res://src/enemies/mini_bosses/centipede/res/part_sprite_frames.tres")
var tail_sprite_frames = preload("res://src/enemies/mini_bosses/centipede//res/tail_sprite_frames.tres")
var part_collision_shape = preload("res://src/enemies/mini_bosses/centipede/res/part_collision_shape.tres")
var part_hit_box_shape = preload("res://src/enemies/mini_bosses/centipede/res/part_hit_box_shape.tres")
...
func _physics_process(delta):
	...
	if velocity:
		...
		sprite.rotation = direction.angle() + deg2rad(0)              
...
func _move_part(index: int, position: Vector2):
	...
	part.node.rotation = dist.angle() + deg2rad(0)
...
func _add_part(index: int):
	...
	node.set_script(Global.classes.parent_accessor)
	...
	part_hurt_box.shape = part_hit_box_shape
	hurt_box.add_child(part_hurt_box)
	
	var part_hit_box = CollisionShape2D.new()
	part_hit_box.shape = part_hit_box_shape
