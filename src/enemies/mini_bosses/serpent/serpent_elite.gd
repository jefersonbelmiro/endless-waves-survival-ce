...
var part_sprite_frames = preload("res://src/enemies/mini_bosses/serpent/res/part_sprite_frames.tres")
var tail_sprite_frames = preload("res://src/enemies/mini_bosses/serpent//res/tail_sprite_frames.tres")
var part_collision_shape = preload("res://src/enemies/mini_bosses/serpent/res/part_collision_shape.tres")
...
func _move_part(index: int, position: Vector2):
	...
	part.node.rotation = dist.angle() + deg2rad(90)
